...
import './BidderHomeNavBar.css'

const BidderHomeNavBar = () => {
    const navigate = useNavigate()
    return (

        <header className='mainHeader bidderHomeNavHeader' >
            <nav className='mainNav' >
                ...
                <ul className='mainNavListParent bidderNavListParent' >
                    ...
                    <button onClick={() => navigate('/bidder/signin')} className='HomeBtn' >
                        Login
