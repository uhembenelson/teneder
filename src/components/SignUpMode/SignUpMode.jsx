...
const SignUpMode = ({ setShowSignUpModal }) => {
    const navigate = useNavigate()
    return (
        <div className='loginModeLayout' >
            <div className='LoginModeContainer'>
                <svg onClick={() => setShowSignUpModal(false)} className='cancelSVG' width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h1 className='modeHeader' >SIGN UP AS </h1>
                <div className='modeContainer' >
                    <div onClick={() => navigate('/bidder/signup')} className='modeHolder' >
                        <img src={bidder} alt='bidder' />
                        <h3>BIDDER</h3>
                    </div>
                    <div onClick={() => navigate('/organization/signup')} className='modeHolder' >
