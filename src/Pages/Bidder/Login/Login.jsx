...
const Login = () => {
    ...
    const loginBidder = async () => {
        const userLoginDetails = getValues()
        try {
            setIsLoading(true)
            let res = await fetch(`https://school-project-production-459d.up.railway.app/v2/auth/signin`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className='loginContainer' >
            ...
            <div className='loginBox' >
                ...
                <form onSubmit={handleSubmit(loginBidder)} className='loginForm' >
                    ...
                    <div className='loginInputContainer' >
                        ...
                        <input className='loginInput' {...register('email')} type='email' />
                    </div>
