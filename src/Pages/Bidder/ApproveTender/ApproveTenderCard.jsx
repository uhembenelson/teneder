...
const ApproveTenderCard = ({ tender, id }) => {
    ...
    switch (tender?.contract_status) {
        case "cancelled":
            option = (
                <div>
                    <p>CANCELLED</p>
                    <img style={{ margin: "auto" }} src={cancel} alt="cancel" />
                </div>
            );
            break;
        case "rejected":
        ...
        case "ongoing":
            option = (
                <div>
                    <p>ON-GOING</p>
                    <img style={{ margin: "auto" }} src={checked} alt="cancel" />
                </div>
            );
            break;
        case "result pending":
            option = (
                <div>
                    <p>PENDING</p>
                    <img style={{ margin: "auto" }} src={HourGlass} alt="cancel" />
                </div>
            );
            break;
        ...
        default:
            option = (
                <div>
                    <p>SELECTED</p>
                    <img style={{ margin: "auto" }} src={approval} alt="approval" />
                </div>
            );
    }
    ...
    return (
        <tr onClick={select}>
            ...
            <td>{tender?.name_of_organization}</td>
            <td>
                <p>{option}</p>
            </td>
        </tr>
